...
public final class XmlParser {
    ...
    public XmlParser(XMLEventReader reader) {
        this.reader = reader;
    }
    ...
    public static Schema getSchema(final String resource) throws SAXException {
        ...
        URL xsdURL = XmlParser.class.getResource(resource);
     ...
     * @throws XMLStreamException the XML stream exception
     */
    public StartElement getNextStartElement(final String name)
            throws XMLStreamException {
        while (true) {
            StartElement startElement = getNextStartElement();
     ...
     * @throws XMLStreamException the XML stream exception
     */
    public StartElement getNextStartElement() throws XMLStreamException {
        while (reader.hasNext()) {
            XMLEvent event = reader.nextEvent();
            if (event.isStartElement()) {
